...
public class MixedNumber implements MixedNumberInterface, Comparable<MixedNumber>
{
	...
	public MixedNumber(int integerPart, int fractionNumerator, int fractionDenominator)
	{
	...
	public void setMixedNumber(int integerPart, int fractionNumerator, int fractionDenominator)
	{
                ...
                // check for exception cases
                this.integer=integerPart;
                this.fraction=newFraction(fractionNumberator, fractionDenominator);
                reduceToLowestForm();
                adjustSigns();
        }       // end setMixedNumber
	...
	public MixedNumberInterface divide(MixedNumberInterface operand)
	{
                // add statements
		// convert MixedNumber objects to Fraction objects
		...
		// convert result to lowest term MixedNumber object
                // hint: return new MixedNumber(0,result);
                Fraction fraction1 =(fraction)this.getFractionalEquivalent();
                Fraction fraction2 =(fraction)((MixedNumber)divisor).getFractionEquivalent();
